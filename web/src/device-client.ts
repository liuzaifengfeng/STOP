...
type Pending = { resolve: (frame: StopFrame) => void; reject: (error: Error) => void; timer: number }
...
export class StopDeviceClient {
  ...
  async otaUpdate(image: Uint8Array, version: string, onProgress: (progress: OtaProgress) => void): Promise<void> {

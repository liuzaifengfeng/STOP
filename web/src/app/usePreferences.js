...
const theme = ref(readChoice(THEME_KEY, ['system', 'light', 'dark'], 'system'));
const sidebar = ref(readChoice(SIDEBAR_KEY, ['expanded', 'auto', 'collapsed'], 'auto'));
const language = ref(readChoice(LANGUAGE_KEY, ['zh-CN', 'en'], 'zh-CN'));
...
export function usePreferences() {
    ...
    const t = (key) => messages[language.value][key];
